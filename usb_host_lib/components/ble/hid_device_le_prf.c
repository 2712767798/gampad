...
0X26,0XFF,0XFF,                //GLOBAL_LOCAL_MAXIMUM(-1)
0X35,0X00,                     //GLOBAL_PHYSICAL_MINIMUM(0)
0X46,0XFF,0XFF,                //GLOBAL_PHYSICAL_MAXIMUM(65535)
...
0x09,0x33,                     //LOCAL_USAGE(Rx)
0x09,0x34,                     // LOCAL_USAGE(Ry)
0X15,0X00,                     //5GLOBAL_LOGICAL_MINIMUM(0)
0X26,0XFF,0XFF,                //GLOBAL_LOCAL_MAXIMUM(-1)
0X35,0X00,                     //GLOBAL_PHYSICAL_MINIMUM(0)
0X46,0XFF,0XFF,                //GLOBAL_PHYSICAL_MAXIMUM(65535)
0x75, 0x10,                    //   REPORT_SIZE (16)
...
// 0x25, 0x07,                    //   LOGICAL_MAXIMUM (7),八个逻辑方向
...
// 0x19, 0x07,                    //   Usage Minimum (Button 1)
// 0x29, 0x0A,                    //   Usage Maximum (Button 4)
// 0x15, 0x00,                    //   Logical Minimum (0)
// 0x25, 0x01,                    //   Logical Maximum (1)
// 0x75, 0x01,                    //   Report Size (1)
// 0x95, 0x04,                    //   Report Count (4)
    ...
    switch(event) {
        ...
        case ESP_GATTS_CREAT_ATTR_TAB_EVT: {
            if (param->add_attr_tab.num_handle == BAS_IDX_NB &&
                ...
                incl_svc.start_hdl = param->add_attr_tab.handles[BAS_IDX_SVC];//记录句柄
                ...
                esp_ble_gatts_create_attr_tab(hidd_le_gatt_db, gatts_if, HIDD_LE_IDX_NB, 0);//创建hid属性表
            }
